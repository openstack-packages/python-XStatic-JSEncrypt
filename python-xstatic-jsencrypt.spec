...
Version:        XXX
Release:        1%{?dist}
Summary:        JSEncrypt JavaScript library packaged for setuptools

License:        MIT
URL:            http://git.openstack.org/cgit/stackforge/xstatic-jsencrypt/
...
%description
JSEncrypt javascript library packaged for
...
%{python_sitelib}/xstatic/pkg/jsencrypt
